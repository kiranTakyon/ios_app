...
class MyProfileController: UIViewController,UITableViewDataSource, UITableViewDelegate,UIPopoverPresentationControllerDelegate,TaykonProtocol {
    ...
    var icons = ["User","User","Email","Mobile","LocationGray","Email"]
    var placeHolders = ["Name","User Name","Email","Mobile No","Address","Verified Email"]
    var titles = ["","","","","",""]
    ...
    func setUIUserInteractionDisabledAndAble(cell :ProfileCell,color: UIColor,interactionStatus: Bool){
        if (cell.icon.image == #imageLiteral(resourceName: "User") && cell.titleTextField.placeholder == "User Name") ||   (cell.icon.image ==  #imageLiteral(resourceName: "Email") && cell.titleTextField.placeholder == "Verified Email"){
...
//        }
    ...
    func convertTheImageToBase64(image: UIImage) -> String{
        ...
        if let base64String = convertImage.base64(format: .png){
            return base64String
        }
        else{
            return ""
    ...
    func setImagePickerWrtType(allowEditing : Bool,sourceType : UIImagePickerControllerSourceType){
