...
//            pickerTextField.resignFirstResponder()
    ...
    @objc func doneAction(){
        ...
        delegate?.pickerSelector!(selectedIndex!)
        pickerTextField.resignFirstResponder()
    ...
    func setDatePicker(){
        ...
        datePickerView.addTarget(self, action: #selector(Picker.handleDatePicker(_:)), for: UIControl.Event.valueChanged)
    ...
    func setTimePicker(){
        ...
        timePickerView.addTarget(self, action: #selector(Picker.handleTimePicker(_:)), for: UIControl.Event.valueChanged)
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        if dropDownItemsArray.count > 0{
            ...
            selectedValue = dropDownItemsArray[row] 
            selectedIndex = row
        }
    }
            ...
            if dropDownItemsArray.count != 0 {
                if pickerType == .picker {
                    if let textFieldText = textField.text,
                        ...
                        textField.text = dropDownItemsArray[0]
                    }
