...
class PaymentDetailsController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func setUI(){
        ...
        self.paymentDetailTable.rowHeight = UITableViewAutomaticDimension
        if finance == 2{
            titleLabel.text = "Fee Details"
              self.secondSectionNameLabel.text = "Fee Details"
        }
        else if finance == 1{
            ...
            self.secondSectionNameLabel.text = "Absent Details"
    ...
    func setSectionHeader(){
        ...
        if finance == 1{
            ...
            self.secondSectionNameLabel.text = "Payment Details"
        ...
        if tableView == StudentDetailTableView{
            ...
            if indexPath.row == 0{
                ...
                if let titleVal = classValue.division{
                    ...
                    cell.titlePlaceHolder.text = "Class and Division"
                }
            }
            ...
            if finance == 3{
                ...
                let cell = tableView.dequeueReusableCell(withIdentifier: "PaymentDetailCell", for: indexPath) as! PaymentDetailCell
                    ...
                    if absentDetails.count > 0{
                        ...
                        cell.receiptNumberLabel.text = "Day: " + item.day.safeValue
                        cell.dateLabel.text = "Date: " + item.date.safeValue
                        cell.amount.text = "Type: " + item.type.safeValue
                    }
                ...
                if self.payemntDetails.count <= indexPath.row{
                    ...
                    if finance == 2{
                    cell.totalTitleLabel.text = "Total:" + " " +  String(self.totalEstimateOfFee())
                        cell.totalLabel.text = "Total Paid:" + " " +  String(self.totalEstimateOfPaid())//
                    }
                    else{
                    ...
                    if let receiptNo = paymentDetail.receiptNo{
                        cell.receiptNumberLabel.text = "Receipt No : \(receiptNo)"
                    }else if let fee = paymentDetail.fee{
                        cell.receiptNumberLabel.text = "Fee : \(fee)"
                    }
                    
                    if let date = paymentDetail.date{
                        if finance == 2{
                        cell.dateLabel.text = "Month: \(date)"
                        }
                        else if finance == 1{
