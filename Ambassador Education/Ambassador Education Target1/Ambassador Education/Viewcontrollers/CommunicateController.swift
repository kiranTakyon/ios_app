...
class CommunicateController: UIViewController,UITableViewDataSource, UITableViewDelegate,TaykonProtocol {
    ...
    func getMsgs(notification : NSNotification){
    ...
    func setRefreshControll(){
        ...
        refreshControl.addTarget(self, action: #selector(CommunicateController.refresh(sender:)), for: UIControlEvents.valueChanged)
